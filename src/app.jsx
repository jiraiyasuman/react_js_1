...
const products = [
    {
        ...
        isAvailable: true,
        image: './components/images/fresh-milk.png',
        price: 14
    },
    {
        pID: 2,
        ...
        desc: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit fuga autem maiores necessitatibus.',
        isAvailable: true,
        image: "./components/images/cottage-cheese.png",
        price: 10
    },
    {
        pID: 3,
        ...
        desc: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit fuga autem maiores necessitatibus.',
        isAvailable: true,
        image: "./components/images/brocoli.png",
        price: 15
    },
    {
        pID: 4,
        ...
        desc: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit fuga autem maiores necessitatibus.',
        isAvailable: true,
        image: "./components/images/oranges.png",
        price: 20
    },
    {
        pID: 5,
        ...
        desc: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit fuga autem maiores necessitatibus.',
        isAvailable: true,
        image: "./components/images/olive-oil.png",
        price: 14
    },
    {
        pID: 6,
